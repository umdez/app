...
Registrador.prototype.configurar = function(servidor, ligar) {
 ...
 */
Registrador.prototype.adcRegistroEventosPara = function (servidor, seLigar) {
...
Registrador.prototype.debug = function(mensagem) {
  // Obsoleto, deletar!
  if (this.seLigado) {
...
Registrador.prototype.info = function(mensagem) {
  // Obsoleto, deletar!
  if (this.seLigado) {
